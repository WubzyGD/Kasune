...
module.exports = {
    ...
    help: new Discord.MessageEmbed()
        ...
        .addField("Notice", "This command is only available to Kit developers."),
    meta: {
        category: 'Developer',
        description: "Refresh all client commands and events and clear most of the require cache.",
        syntax: '`reload`',
        extra: null
    },
    async execute(message, msg, args, cmd, prefix, mention, client) {
        if (!args.length) {
            if (!client.developers.includes(message.author.id)) {return message.channel.send("You must be a Kit developer in order to do this!");}
