...
module.exports = {
    ...
    async execute(message, msg, args, cmd, prefix, mention, client) {
        ...
        if (incl(["thanks Kit", "thank you Kit", "ty Kit"])) {
        ...
        if (incl(['gn Kit', 'goodnight Kit', 'night Kit'])) {
        ...
        if (inc('anime') && incl(['we binging', 'am i watching', 'should i watch', 'to watch', 'we watching', "am i gonna watch", "are we gonna watch"]) && inc("Kit")) {
            async function q() {
                let sconf;
        ...
        if (['hey Kit', 'hey Kit?', 'yo Kit'].includes(msg.trim())) {
