...
async function init() {
    ...
    try {
        await mongoose.connect(`mongodb+srv://${config.database.user}:${config.database.password}@${config.database.cluster}.uqyvv.mongodb.net/test`, {
            useFindAndModify: false, useNewUrlParser: true, dbName: 'Neptune', useUnifiedTopology: true, useCreateIndex: true
        }).catch(e => {
    ...
    client.developers = ["330547934951112705", "443166863996878878"];
    client.utils = {};
